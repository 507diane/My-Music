...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        listArray = ["Elton John","One Direction","Josh Groban","Billy Joel","Eva Cassidy", "Aaron Neville","Frank Sinatra", "Harry Connick Jr","Louis Armstrong","Michael Bublé","Sara Bareilles","Enya"]
